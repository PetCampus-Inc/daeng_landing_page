...
export function MainIntroSection() {
  return (
    <section className="relative min-h-svh flex justify-center bg-gradient-to-b from-[#FFF] to-[#FFF8EF]">
      <Content className="flex min-h-svh items-center justify-center pt-header">
